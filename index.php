            ...
            <main>
                ...
                <div class="popular-wrapper">
                    ...
                    <div class="carousel owl-carousel">
                        ...
                        $yazilar = $db->prepare("SELECT * FROM yazilar
                            ...
                            WHERE yazi_durum=? ORDER BY yazi_okunma DESC LIMIT 5");
                        $yazilar->execute(array(1));
                        $yazi_listele = $yazilar->fetchALL(PDO::FETCH_ASSOC);

                        foreach ($yazi_listele as $row) { ?>
                            <div class="popular-card card-1"><a href="yazilar/<?php echo $row['yazi_seolink']; ?>"><img src="img/yazilar/<?php echo $row["yazi_foto"]; ?>" alt="<?php echo $row["yazi_title"] ?>" title="<?php echo $row["yazi_title"] ?>"></a></div>
                        <?php } ?>
                    </div>
                </div>
                ...
                <div class="new-wrapper">
                    ...
                    <div class="grid">
                        ...
                        $yazi_say = $db->query("SELECT *FROM yazilar WHERE yazi_durum=1");
                    ...
                    <div class="pagination">
                        <ul>
                            <div class="li-container">
                                <?php if($sayfa > 1) { ?>
                                    <li><a href="sayfa/<?php echo $sayfa - 1 ?>"><i class="fas fa-angle-left"></i></a></li>
                                <?php } ?>
                                ...
                                <?php if ($sayfa != $sayfasayisi) { ?>
                                    <li><a href="sayfa/<?php echo $sayfa + 1 ?>"><i class="fas fa-angle-right"></i></a></li>
                                <?php } ?>
                            </div>
                        </ul>
                    </div>
