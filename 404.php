        ...
        <div class="main-content">
            <main>
                ...
                <div class="new-wrapper">
                    <h2 style="background-color: #d54062; padding: 5px; box-sizing: border-box; border-radius: 5px;">Error 404 - Sayfa Bulunamadı.</h2>
                    <p style="font-size: 18px;">Bu sayfa bu sitede ne yazık ki bulunmamaktadır. Lütfen <a href="#" class="e404">anasayfaya</a> dönünüz.</p>
